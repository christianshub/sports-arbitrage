                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '+0.75') and (XB_info2 == '-3.75'):
                            o1o2("AO: AH1 +0.75", AO_team1, AO_team2, AO_odd1, "BE: AH2 -3.75", XB_team1, XB_team2, XB_odd2)
                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '+1.25') and (XB_info2 == '-4.25'):
                            o1o2("AO: AH1 +1.25", AO_team1, AO_team2, AO_odd1, "BE: AH2 -4.25", XB_team1, XB_team2, XB_odd2)
                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '+1.5') and (XB_info2 == '-4.5'):
                            o1o2("AO: AH1 +1.5", AO_team1, AO_team2, AO_odd1, "BE: AH2 -4.5", XB_team1, XB_team2, XB_odd2)
                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '+1.75') and (XB_info2 == '-4.75'):
                            o1o2("AO: AH1 +1.75", AO_team1, AO_team2, AO_odd1, "BE: AH2 -4.75", XB_team1, XB_team2, XB_odd2)
                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '-0.75') and (XB_info2 == '-2.25'):
                            o1o2("AO: AH1 -0.75", AO_team1, AO_team2, AO_odd1, "BE: AH2 -2.25", XB_team1, XB_team2, XB_odd2)
                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '-1.25') and (XB_info2 == '-1.75'):
                            o1o2("AO: AH1 -1.25", AO_team1, AO_team2, AO_odd1, "BE: AH2 -1.75", XB_team1, XB_team2, XB_odd2)
                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '-1.5') and (XB_info2 == '-1.5'):
                            o1o2("AO: AH1 -1.5", AO_team1, AO_team2, AO_odd1, "BE: AH2 -1.5", XB_team1, XB_team2, XB_odd2)
                ...
                for XB_list in XB_HDP:
                    ...
                    if sameNames(AO_team1, AO_team2, XB_team1, XB_team2):
                        ...
                        if (AO_info == '-1.75') and (XB_info2 == '-1.25'):
                            o1o2("AO: AH1 -1.75", AO_team1, AO_team2, AO_odd1, "BE: AH2 -1.25", XB_team1, XB_team2, XB_odd2)
